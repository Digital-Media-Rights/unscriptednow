...
<div id="nav">
	<ul>
        ...
        <li><a href="<?php echo get_bloginfo("url")."/"."watch-unscripted/"?>" <?php if (is_page_template("page-where-to-what.php") || is_page_template("page-where-to-what-canada.php")) echo 'class="active"'; ?> id="n5"><?php echo __('WATCH ASIAN CRUSH') ?></a></li>
        ...
        <li><a href="<?php echo get_bloginfo("url")."/"."about-unscripted/"?>" <?php if (is_page("about-unscripted")) echo 'class="active"'; ?> id="n7"><?php echo __('ABOUT') ?></a></li>
    </ul>
</div> <!-- end nav -->