<ul id="subnav">
	<li id="sn1">
    	<ul>
            ...
            <li><a href="<?php echo site_url('watch-asian-crush') ?>"><?php echo __('Watch Unscripted{Now}') ?></a></li>
    ...
    <li id="sn2">
    	<ul>
            ...
            <li><a href="<?php echo site_url('about-asian-crush') ?>"><?php echo __('About Unscripted{Now}') ?></a></li>
