...
function amr_theme_setup() {
    ...
    register_sidebar( array(
        'name' => __( 'Footer-1st', 'Unscripted{Now}' ),
        'id' => 'footer-1st',
        'description' => __( 'Footer 1st area', 'Unscripted{Now}' ),
    ...
    register_sidebar( array(
        'name' => __( 'Footer-2nd', 'Unscripted{Now}' ),
        'id' => 'footer-2nd',
        'description' => __( 'Footer 2nd area', 'Unscripted{Now}' ),
        'before_widget' => '<li id="%1$s">',
    ...
    register_sidebar( array(
        'name' => __( 'Footer-3rd', 'Unscripted{Now}' ),
        'id' => 'footer-3rd',
        'description' => __( 'Footer 3rd area', 'Unscripted{Now}' ),
        'before_widget' => '<li id="%1$s">',
...
/* Advertise widget start */
    ...
    register_sidebar( array(
        'name' => __( 'Advertise Right Area', 'Unscripted{Now}' ),
        'id' => 'ad-right',
        'description' => __( 'Search Page', 'Unscripted{Now}' ),
...
/* Advertise widget start */
    ...
    register_sidebar( array(
        'name' => __( 'Advertise header Area', 'Unscripted{Now}' ),
        'id' => 'ad-header',
        'description' => __( 'Image size 729px - 91px', 'Unscripted{Now}' ),
...
function amr_export_contact_us()
{
	...
	$worksheet =& $workbook->addWorksheet('Unscripted{Now} Contact list');
...
function amr_export_submitted_film()
{
	...
	// Creating a worksheet
	$worksheet =& $workbook->addWorksheet('Unscripted{Now} Submitted Film list');
